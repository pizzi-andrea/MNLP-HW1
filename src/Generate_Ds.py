...
if __name__ == '__main__':
    ...
    factory.produce(train_l, 'train.tsv', ['category', 'subcategory','type','languages','reference','num_langs', 'G'], 'label', 10, False)
    factory.produce(validation_l, 'validation.tsv', ['category', 'subcategory','type','languages','reference','num_langs', 'G'], 'label', 10, False)
    print('End process')
    exit(0)
